...
echo "<br>string1:: $str1<br>string2:: $str2<br>string for replace:: $str<br>";
if ($str1 > $str2) {
        switch ($ch) {
                case 1:
                        echo "<br>First occ is at position :";
                        echo strpos($str1, $str2);
                        echo "<br>Last  occ is at position :";
                ...
                case 3:
                        ...
                        echo "<br>After replacing string is::$str3";
                        break;
        }
} else {
        switch ($ch) {
                ...
                case 3:
                        ...
                        echo "<br>After replacing string::'$str3'.";
                        break;
        }
}

?>
<h1><a href='2.html'>go back</a></h1>